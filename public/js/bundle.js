        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // reload front page
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHV2bzExMDYiLCJhIjoiY2swYmw2azdkMHZrcTNtcWxhZDA1eTJuZCJ9.puiViLqEkfEvMA66Ctj1vQ';
...
var stripe = Stripe('pk_test_kxLc36OyS7Y3bQ2F2QWPfIJg00Ogu4lqMB');
...
var signUpBtn = document.querySelector('.form__signUp');
